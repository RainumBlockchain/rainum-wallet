...
const DEFAULT_GLOW_COLOR = '0, 25, 255';
...
const defaultCardData: BentoCardProps[] = [
  ...
  },
  {
    color: '#ffffff',
    title: 'Connect',
    description: 'Use MetaMask or WalletConnect',
    label: 'Link'
  },
  {
    color: '#ffffff',
  ...
  },
  {
    color: '#ffffff',
    title: 'Fast',
    description: 'Built on Rainum blockchain',
    label: 'Speed'
  },
  {
    color: '#ffffff',
      ...
      <style>
        {`
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(0, 25, 255, 0.2);
          }
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-4">
          {cardData.map((card, index) => {
            ...
            const baseClassName = `card flex flex-col justify-between relative w-full p-6 rounded-[20px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 ${
              enableBorderGlow ? 'card--border-glow' : ''
            }`;

            const cardStyle = {
              backgroundColor: isPrimary ? 'var(--blue-primary)' : 'rgba(255, 255, 255, 0.9)',
              borderColor: 'var(--border-color)',
              color: isPrimary ? '#ffffff' : 'var(--text-dark)',
